#ifndef _ROS_sensor_msgs_ext_analog_voltage_h
#define _ROS_sensor_msgs_ext_analog_voltage_h
...
namespace sensor_msgs_ext
{
  ...
  class analog_voltage : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "sensor_msgs_ext/analog_voltage"; };
    virtual const char * getMD5() override { return "cd1e97d74e6d797b46bc5a51e820e6ae"; };
