...
if __name__ == "__main__":
    ...
    filtered_accel = Imu(header=header)
    rospy.init_node('accelerometer_filter')
    accel_pub = rospy.Publisher('accel_pub', Imu, queue_size=1000)
    while(1):
        ...
        accel_data['x'], accel_data['y'], accel_data['z'] = filtered_accel.linear_acceleration.x, filtered_accel.linear_acceleration.y, filtered_accel.linear_acceleration.z
        gyro_data['x'], gyro_data['y'], gyro_data['z'] = filtered_accel.angular_velocity.x, filtered_accel.angular_velocity.y, filtered_accel.angular_velocity.z
