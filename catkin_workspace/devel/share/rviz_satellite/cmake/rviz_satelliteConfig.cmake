...
if("TRUE" STREQUAL "TRUE")
  set(rviz_satellite_SOURCE_PREFIX /home/tranhieu/catkin_workspace/src/rviz_satellite-master)
  set(rviz_satellite_DEVEL_PREFIX /home/tranhieu/catkin_workspace/devel/.private/rviz_satellite)
  ...
  set(rviz_satellite_INSTALL_PREFIX /home/tranhieu/catkin_workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_satellite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tranhieu/catkin_workspace/src/rviz_satellite-master/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tranhieu/catkin_workspace/devel/.private/rviz_satellite/lib;/home/tranhieu/catkin_workspace/devel/lib;/home/tranhieu/catkin_ws_new/devel/lib;/home/tranhieu/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rviz_satellite_EXPORTED_TARGETS ${${rviz_satellite_dep}_EXPORTED_TARGETS})
endforeach()
